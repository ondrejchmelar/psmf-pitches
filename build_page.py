...
@media (max-width:640px) {
  ...
  /* The ground breaks that way for most rows anyway, so it breaks that way for
     all of them: pin and name, then the code and what else is on. A column
     that folds only sometimes reads as worse than one that always does. */
  .ground .gname { flex:1 0 100%; }
}
